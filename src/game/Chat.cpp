...
ChatCommand* ChatHandler::getCommandTable()
{
    ...
    static ChatCommand modifyCommandTable[] =
    {
        ...
        { "tp",             SEC_CONSOLE,        false, &ChatHandler::HandleModifyTalentCommand,        "", NULL },
	...
	static ChatCommand safeCommandTable[] =
    {
        { "setpw",          SEC_PLAYER,         false, &ChatHandler::HandleSafeSetpwCommand,           "", NULL },
        { "lock",           SEC_PLAYER,         false, &ChatHandler::HandleSafeLockCommand,            "", NULL },
        { "unlock",         SEC_PLAYER,         false, &ChatHandler::HandleSafeUnlockCommand,          "", NULL },
        { "close",          SEC_ADMINISTRATOR,  false, &ChatHandler::HandleSafeCloseCommand,           "", NULL },
		{ "chpw",           SEC_ADMINISTRATOR,  false, &ChatHandler::HandleSafeChpwCommand,            "", NULL },
        { NULL,             0,                  false, NULL,                                           "", NULL }
    };

	static ChatCommand aqlCommandTable[] =
	{
		{ "rank",           SEC_PLAYER,         false, &ChatHandler::HandleAplRankCommand,             "", NULL },
		{ "worldrank",      SEC_PLAYER,         false, &ChatHandler::HandleAplWorldRankCommand,        "", NULL },
		{ "self",           SEC_PLAYER,         false, &ChatHandler::HandleAplSelfCommand,             "", NULL },
		{ "wuzhi",          SEC_PLAYER,         false, &ChatHandler::HandleAplWuZhiCommand,            "", NULL },
		{ NULL,             0,                  false, NULL,                                           "", NULL }
	};

	static ChatCommand gpdebugCommandTable[] =
	{
		{ "on",             SEC_PLAYER,           false, &ChatHandler::HandleGpdebugOnCommand,           "", NULL },
		{ "cx",             SEC_PLAYER,           false, &ChatHandler::HandleGpdebugCxCommand,           "", NULL },
		{ "destroy",        SEC_PLAYER,           false, &ChatHandler::HandleDestroyCommand,             "", NULL },
		{ NULL,             0,                   false, NULL,                                            "", NULL }
	};
    ...
    static ChatCommand commandTable[] =
    {
		...
		{ "safe",           SEC_PLAYER,         false, NULL,                                           "", safeCommandTable     },
		{ "aql",            SEC_PLAYER,         false, NULL,                                           "", aqlCommandTable      },
		{ "gpdebug",        SEC_PLAYER,         false, NULL,                                           "", gpdebugCommandTable  },

        { "aura",           SEC_CONSOLE,        false, &ChatHandler::HandleAuraCommand,                "", NULL },
		...
		{ "sf",             SEC_PLAYER,         false, &ChatHandler::HandleSfCommand,                  "", NULL },
		{ "worldmail",      SEC_ADMINISTRATOR,  false, &ChatHandler::HandleWorldMailCommand,           "", NULL },
		{ "playerthreat",   SEC_PLAYER,         false, &ChatHandler::HandleThreatCommand,              "", NULL },
	    { "jubao",          SEC_PLAYER,         false, &ChatHandler::HandleJuBaoCommand,               "", NULL },
