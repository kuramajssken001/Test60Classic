...
class MANGOS_DLL_SPEC ChatHandler
{
    ...
    protected:
		...
		bool HandleSafeSetpwCommand(char* args);
		bool HandleSafeLockCommand(char* args);
		bool HandleSafeUnlockCommand(char* args);
		bool HandleSafeCloseCommand(char* args);
		bool HandleSafeChpwCommand(char* args);

		bool HandleAplRankCommand(char* args);
		bool HandleAplWorldRankCommand(char* args);
		bool HandleAplSelfCommand(char* args);
		bool HandleAplWuZhiCommand(char* args);

		bool HandleGpdebugOnCommand(char* args);
		bool HandleGpdebugCxCommand(char* args);
		bool HandleDestroyCommand(char* args);
		...
		bool HandleTianFuCommand(char* args);
		bool HandleSaveTfCommand(char* args);
		bool HandleChaXunCommand(char* args);
		bool HandleAddzcCommand(char* args);
		bool HandleLiBaoCommand(char* args);
		bool HandleYcCommand(char* args);
		bool HandleSfCommand(char* args);
		bool HandleThreatCommand(char* args);
		bool HandleWorldMailCommand(char* args);
		bool HandleJuBaoCommand(char* args);
		bool HandleChouhenDebugCommand(char* args);
	  /*bool HandleYqZyCommand(char* args);
		bool HandleQxZyCommand(char* args);
		bool HandleCxZyCommand(char* args);*/
