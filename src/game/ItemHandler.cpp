...
void WorldSession::HandleDestroyItemOpcode(WorldPacket& recv_data)
{
	...
	{
		_player->SendEquipError(EQUIP_ERR_CANT_DROP_SOULBOUND, pItem, NULL);
...
void WorldSession::HandleBuyItemOpcode(WorldPacket& recv_data)
{
	...
	if (sWorld.getConfig(CONFIG_BOOL_SAFE_LOCK) && GetPlayer()->GetPlayerSafe() == 0)
	{
		ChatHandler(GetPlayer()).PSendSysMessage(LANG_SAFE_20);
		return;
	}
					...
					switch (pProto->ItemId)
					{
						...
						case 18795:
							if (_player->getRace() != RACE_TAUREN)
							    if (uint32(_player->GetReputationRank(pCreature->getFactionTemplateEntry()->faction)) != 7)
									continue;
							break;
						case 8588:
						case 8591:
						...
						case 13334:
						case 18791:
							if (_player->getRace() != RACE_UNDEAD)
							   if (uint32(_player->GetReputationRank(pCreature->getFactionTemplateEntry()->faction)) != 7)
								   continue;
							break;
						case 2411:
						...
						case 18767:
						case 18902:
							if (_player->getRace() != RACE_NIGHTELF)
							    if (uint32(_player->GetReputationRank(pCreature->getFactionTemplateEntry()->faction)) != 7)
								    continue;
							break;
					}
...
void WorldSession::HandleWrapItemOpcode(WorldPacket& recv_data)
{
	...
	{
		if (_player->GetCurrentSpell(CurrentSpellTypes(i)))
		{
