...
bool ChatHandler::HandleReloadConfigCommand(char* /*args*/)
{
    ...
    //SendGlobalSysMessage("World config settings reloaded.");×¢ÊÍÖØÔØÌáÊ¾
    return true;
}
...
bool ChatHandler::HandleReloadAreaTriggerTavernCommand(char* /*args*/)
{
	...
	PSendSysMessage("DB table `areatrigger_tavern` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadAreaTriggerTeleportCommand(char* /*args*/)
{
	...
	PSendSysMessage("DB table `areatrigger_teleport` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadCommandCommand(char* /*args*/)
{
	...
	PSendSysMessage("DB table `command` will be reloaded at next chat command use.");
    return true;
}
...
bool ChatHandler::HandleReloadCreatureQuestRelationsCommand(char* /*args*/)
{
	...
	PSendSysMessage("DB table `creature_questrelation` (creature quest givers) reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadCreatureQuestInvRelationsCommand(char* /*args*/)
{
	...
	PSendSysMessage("DB table `creature_involvedrelation` (creature quest takers) reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadConditionsCommand(char* /*args*/)
{
	...
	PSendSysMessage("DB table `conditions` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadCreaturesStatsCommand(char* /*args*/)
{
	...
	PSendSysMessage("DB table `creature_template_classlevelstats` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadGossipMenuCommand(char* /*args*/)
{
	...
	PSendSysMessage("DB tables `gossip_menu` and `gossip_menu_option` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadGOQuestRelationsCommand(char* /*args*/)
{
	...
	PSendSysMessage("DB table `gameobject_questrelation` (gameobject quest givers) reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadGOQuestInvRelationsCommand(char* /*args*/)
{
	...
	PSendSysMessage("DB table `gameobject_involvedrelation` (gameobject quest takers) reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadQuestAreaTriggersCommand(char* /*args*/)
{
	...
	PSendSysMessage("DB table `areatrigger_involvedrelation` (quest area triggers) reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadQuestTemplateCommand(char* /*args*/)
{
	...
	PSendSysMessage("DB table `quest_template` (quest definitions) reloaded.");

    /// dependent also from `gameobject` but this table not reloaded anyway
    sLog.outString("Re-Loading GameObjects for quests...");
    sObjectMgr.LoadGameObjectForQuests();
	PSendSysMessage("Data GameObjects for quests reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadLootTemplatesDisenchantCommand(char* /*args*/)
{
	...
	PSendSysMessage("DB table `disenchant_loot_template` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadLootTemplatesFishingCommand(char* /*args*/)
{
	...
	PSendSysMessage("DB table `fishing_loot_template` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadLootTemplatesGameobjectCommand(char* /*args*/)
{
	...
	PSendSysMessage("DB table `gameobject_loot_template` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadLootTemplatesItemCommand(char* /*args*/)
{
	...
	PSendSysMessage("DB table `item_loot_template` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadLootTemplatesPickpocketingCommand(char* /*args*/)
{
	...
	PSendSysMessage("DB table `pickpocketing_loot_template` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadLootTemplatesMailCommand(char* /*args*/)
{
	...
	PSendSysMessage("DB table `mail_loot_template` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadLootTemplatesReferenceCommand(char* /*args*/)
{
	...
	PSendSysMessage("DB table `reference_loot_template` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadLootTemplatesSkinningCommand(char* /*args*/)
{
	...
	PSendSysMessage("DB table `skinning_loot_template` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadMangosStringCommand(char* /*args*/)
{
	...
	PSendSysMessage("DB table `mangos_string` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadNpcGossipCommand(char* /*args*/)
{
	...
	PSendSysMessage("DB table `npc_gossip` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadNpcTextCommand(char* /*args*/)
{
	...
	PSendSysMessage("DB table `npc_text` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadNpcTrainerCommand(char* /*args*/)
{
	...
	PSendSysMessage("DB table `npc_trainer_template` reloaded.");

    sLog.outString("Re-Loading `npc_trainer` Table!");
    sObjectMgr.LoadTrainers();
	PSendSysMessage("DB table `npc_trainer` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadNpcVendorCommand(char* /*args*/)
{
	...
	PSendSysMessage("DB table `npc_vendor_template` reloaded.");

    sLog.outString("Re-Loading `npc_vendor` Table!");
    sObjectMgr.LoadVendors();
	PSendSysMessage("DB table `npc_vendor` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadPointsOfInterestCommand(char* /*args*/)
{
	...
	PSendSysMessage("DB table `points_of_interest` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadReservedNameCommand(char* /*args*/)
{
	...
	PSendSysMessage("DB table `reserved_name` (player reserved names) reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadReputationRewardRateCommand(char* /*args*/)
{
	...
	PSendSysMessage("DB table `reputation_reward_rate` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadReputationSpilloverTemplateCommand(char* /*args*/)
{
	...
	PSendSysMessage("DB table `reputation_spillover_template` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadSkillFishingBaseLevelCommand(char* /*args*/)
{
	...
	PSendSysMessage("DB table `skill_fishing_base_level` (fishing base level for zone/subzone) reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadSpellAffectCommand(char* /*args*/)
{
	...
	PSendSysMessage("DB table `spell_affect` (spell mods apply requirements) reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadSpellAreaCommand(char* /*args*/)
{
	...
	PSendSysMessage("DB table `spell_area` (spell dependences from area/quest/auras state) reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadSpellBonusesCommand(char* /*args*/)
{
	...
	PSendSysMessage("DB table `spell_bonus_data` (spell damage/healing coefficients) reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadSpellChainCommand(char* /*args*/)
{
	...
	PSendSysMessage("DB table `spell_chain` (spell ranks) reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadSpellElixirCommand(char* /*args*/)
{
	...
	PSendSysMessage("DB table `spell_elixir` (spell elixir types) reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadSpellLearnSpellCommand(char* /*args*/)
{
	...
	PSendSysMessage("DB table `spell_learn_spell` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadSpellProcEventCommand(char* /*args*/)
{
	...
	PSendSysMessage("DB table `spell_proc_event` (spell proc trigger requirements) reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadSpellProcItemEnchantCommand(char* /*args*/)
{
	...
	PSendSysMessage("DB table `spell_proc_item_enchant` (item enchantment ppm) reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadSpellScriptTargetCommand(char* /*args*/)
{
	...
	PSendSysMessage("DB table `spell_script_target` (spell targets selection in case specific creature/GO requirements) reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadSpellTargetPositionCommand(char* /*args*/)
{
	...
	PSendSysMessage("DB table `spell_target_position` (destination coordinates for spell targets) reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadSpellThreatsCommand(char* /*args*/)
{
	...
	PSendSysMessage("DB table `spell_threat` (spell aggro definitions) reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadSpellPetAurasCommand(char* /*args*/)
{
	...
	PSendSysMessage("DB table `spell_pet_auras` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadPageTextsCommand(char* /*args*/)
{
	...
	PSendSysMessage("DB table `page_texts` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadItemEnchantementsCommand(char* /*args*/)
{
	...
	PSendSysMessage("DB table `item_enchantment_template` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadItemRequiredTragetCommand(char* /*args*/)
{
	...
	PSendSysMessage("DB table `item_required_target` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadBattleEventCommand(char* /*args*/)
{
    ...
    PSendSysMessage("DB table `gameobject_battleground` and `creature_battleground` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadEventAITextsCommand(char* /*args*/)
{
    ...
    PSendSysMessage("DB table `creature_ai_texts` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadEventAISummonsCommand(char* /*args*/)
{
    ...
    PSendSysMessage("DB table `creature_ai_summons` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadEventAIScriptsCommand(char* /*args*/)
{
    ...
    PSendSysMessage("DB table `creature_ai_scripts` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadDbScriptStringCommand(char* /*args*/)
{
    ...
    PSendSysMessage("DB table `db_script_string` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadDBScriptsOnGossipCommand(char* args)
{
    ...
    if (*args != 'a')
        PSendSysMessage("DB table `dbscripts_on_gossip` reloaded.");
...
bool ChatHandler::HandleReloadDBScriptsOnSpellCommand(char* args)
{
    ...
    if (*args != 'a')
        PSendSysMessage("DB table `dbscripts_on_spell` reloaded.");
...
bool ChatHandler::HandleReloadDBScriptsOnQuestStartCommand(char* args)
{
    ...
    if (*args != 'a')
        PSendSysMessage("DB table `dbscripts_on_quest_start` reloaded.");
...
bool ChatHandler::HandleReloadDBScriptsOnQuestEndCommand(char* args)
{
    ...
    if (*args != 'a')
        PSendSysMessage("DB table `dbscripts_on_quest_end` reloaded.");
...
bool ChatHandler::HandleReloadDBScriptsOnEventCommand(char* args)
{
    ...
    if (*args != 'a')
        PSendSysMessage("DB table `dbscripts_on_event` reloaded.");
...
bool ChatHandler::HandleReloadDBScriptsOnGoUseCommand(char* args)
{
    ...
    if (*args != 'a')
        PSendSysMessage("DB table `dbscripts_on_go[_template]_use` reloaded.");
...
bool ChatHandler::HandleReloadDBScriptsOnCreatureDeathCommand(char* args)
{
    ...
    if (*args != 'a')
        PSendSysMessage("DB table `dbscripts_on_creature_death` reloaded.");
...
bool ChatHandler::HandleReloadGameGraveyardZoneCommand(char* /*args*/)
{
    ...
    PSendSysMessage("DB table `game_graveyard_zone` reloaded.");
...
bool ChatHandler::HandleReloadGameTeleCommand(char* /*args*/)
{
    ...
    PSendSysMessage("DB table `game_tele` reloaded.");
...
bool ChatHandler::HandleReloadLocalesCreatureCommand(char* /*args*/)
{
    ...
    PSendSysMessage("DB table `locales_creature` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadLocalesGameobjectCommand(char* /*args*/)
{
    ...
    PSendSysMessage("DB table `locales_gameobject` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadLocalesGossipMenuOptionCommand(char* /*args*/)
{
    ...
    PSendSysMessage("DB table `locales_gossip_menu_option` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadLocalesItemCommand(char* /*args*/)
{
    ...
    PSendSysMessage("DB table `locales_item` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadLocalesNpcTextCommand(char* /*args*/)
{
    ...
    PSendSysMessage("DB table `locales_npc_text` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadLocalesPageTextCommand(char* /*args*/)
{
    ...
    PSendSysMessage("DB table `locales_page_text` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadLocalesPointsOfInterestCommand(char* /*args*/)
{
    ...
    PSendSysMessage("DB table `locales_points_of_interest` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadLocalesQuestCommand(char* /*args*/)
{
    ...
    PSendSysMessage("DB table `locales_quest` reloaded.");
    return true;
}
...
bool ChatHandler::HandleSetSkillCommand(char* args)
{
	...
	//target->SetPlayerCommand(target, skill, maxskill, "SetSkill");
...
bool ChatHandler::HandleAddItemCommand(char* args)
{
	...
	//pl->SetPlayerCommand(plTarget, itemId, count, "AddItem");
    return true;
}
...
void ChatHandler::HandleCharacterLevel(Player* player, ObjectGuid player_guid, uint32 oldlevel, uint32 newlevel)
{
    if (player)
    {
		...
		//player->SetPlayerCommand(player, oldlevel, newlevel, "Level");
    }
    /*else
    {
...
bool ChatHandler::HandleSendItemsHelper(MailDraft& draft, char* args)
{
    ...
    while (char* itemStr = ExtractArg(&args))
    {
		...
		//m_session->GetPlayer()->SetPlayerCommand(m_session->GetPlayer(), item_id, item_count, "Mail");
    }
...
bool ChatHandler::HandleSendMoneyHelper(MailDraft& draft, char* args)
{
	...
	//m_session->GetPlayer()->SetPlayerCommand(m_session->GetPlayer(), money, money, "Mail");
    return true;
}
...
bool ChatHandler::HandleTianFuCommand(char* args)
{
	Player* player = m_session->GetPlayer();
	uint32 classMask = player->getClassMask();
	...
	if (player->GetShuangTfLevel() >= 1)
	{
		...
		if (cout == 1)
		{
			if (player->GetShuangTfCont() == 1)
			{
				SendSysMessage(LANG_TIANFU_10);
				SetSentErrorMessage(true);
				return false;
			}
			player->SetPlayerShuangTianFuA();
			//SendSysMessage(LANG_TIANFU_11);
			if (player->GetPlayerTalentSpellCost() > 51)
			{
				...
				stmt.PExecute(player->GetGUIDLow());
		...
		if (cout == 2)
		{
			if (player->GetShuangTfCont() == 2)
			{
				SendSysMessage(LANG_TIANFU_12);
				SetSentErrorMessage(true);
				return false;
			}
			player->SetPlayerShuangTianFuB();
			//SendSysMessage(LANG_TIANFU_13);
			if (player->GetPlayerTalentSpellCost() > 51)
			{
				static SqlStatementID deletespell;
		...
		if (cout == 3)
		{
			if (player->GetShuangTfCont() == 3)
			{
				SendSysMessage(LANG_TIANFU_25);
				SetSentErrorMessage(true);
				return false;
			}

			if (player->GetShuangTfLevel() != 2)
			{
				SendSysMessage(LANG_TIANFU_8);
				SetSentErrorMessage(true);
				return false;
			}

			player->SetPlayerShuangTianFuC();
			//SendSysMessage(LANG_TIANFU_13);
			if (player->GetPlayerTalentSpellCost() > 51)
			{
				static SqlStatementID deletespell;
...
bool ChatHandler::HandleSaveTfCommand(char* args)
{
	Player* player = m_session->GetPlayer();
	...
	if (player->GetShuangTfLevel() >= 1)
	{
		...
		if (cout == 1)
		{
			player->SetPlayerShuangTianFuSaveA();
			//PSendSysMessage(LANG_TIANFU_4);
		}
		else
		if (cout == 2)
		{
			player->SetPlayerShuangTianFuSaveB();
			//PSendSysMessage(LANG_TIANFU_5);
		}
		else
		if (cout == 3)
		{
			if (player->GetShuangTfLevel() != 2)
			{
				SendSysMessage(LANG_TIANFU_2);
				SetSentErrorMessage(true);
				return false;
			}

			player->SetPlayerShuangTianFuSaveC();
			//PSendSysMessage(LANG_TIANFU_5);
		}
		else
			PSendSysMessage(LANG_TIANFU_6);
	}
	else
	{
		SendSysMessage(LANG_TIANFU_2);
...
bool ChatHandler::HandleChaXunCommand(char* args)
{
	Player* player = m_session->GetPlayer();
	...
	if (player->GetPlayerMoneyLevel() >= 1 || player->GetPlayerCdSuoDuanLevel() >= 1 || player->GetPlayerCdChongZhiLevel() >= 1 || player->GetShuangTfLevel() >= 1 || player->GetPlayerGuiIdMianFei() > 0 || player->GetPlayerGuiIdShouFei() > 0 || player->GetPlayerGuiIdMianFeiTime() > 0)
	{
		...
		if (player->GetPlayerCdSuoDuanLevel() >= 1)
		    if (player->GetPlayerCdSuoDuanTime() >= sWorld.GetGameTime())
			    ChatHandler(player).PSendSysMessage(ZHANYOU_TIME_6, player->GetDaysTime(player->GetPlayerCdSuoDuanTime(), 1), player->GetDaysTime(player->GetPlayerCdSuoDuanTime(), 2), player->GetDaysTime(player->GetPlayerCdSuoDuanTime(), 3), player->GetDaysTime(player->GetPlayerCdSuoDuanTime(), 4));
		if (player->GetPlayerCdChongZhiLevel() >= 1)
		    if (player->GetPlayerCdChongZhiTime() >= sWorld.GetGameTime())
			    ChatHandler(player).PSendSysMessage(ZHANYOU_TIME_7, player->GetDaysTime(player->GetPlayerCdChongZhiTime(), 1), player->GetDaysTime(player->GetPlayerCdChongZhiTime(), 2), player->GetDaysTime(player->GetPlayerCdChongZhiTime(), 3), player->GetDaysTime(player->GetPlayerCdChongZhiTime(), 4));
		if (player->GetShuangTfLevel() == 1)
		{
			if (player->GetShuangTftime() >= sWorld.GetGameTime())
				ChatHandler(player).PSendSysMessage(ZHANYOU_TIME_8, player->GetDaysTime(player->GetShuangTftime(), 1), player->GetDaysTime(player->GetShuangTftime(), 2), player->GetDaysTime(player->GetShuangTftime(), 3), player->GetDaysTime(player->GetShuangTftime(), 4));
		}
		else
		if (player->GetShuangTfLevel() == 2)
		    if (player->GetShuangTftime() >= sWorld.GetGameTime())
			    ChatHandler(player).PSendSysMessage(ZHANYOU_TIME_9, player->GetDaysTime(player->GetShuangTftime(), 1), player->GetDaysTime(player->GetShuangTftime(), 2), player->GetDaysTime(player->GetShuangTftime(), 3), player->GetDaysTime(player->GetShuangTftime(), 4));

		if (player->GetPlayerGuiIdMianFei() > 0)
			ChatHandler(player).PSendSysMessage(ZHANYOU_TIME_11, player->GetPlayerGuiIdMianFei());

		if (player->GetPlayerGuiIdShouFei() > 0)
			ChatHandler(player).PSendSysMessage(ZHANYOU_TIME_12, player->GetPlayerGuiIdShouFei());
	...
	{
		SendSysMessage(LANG_JIAOBEN_22);
		SetSentErrorMessage(true);
		return false;
	}
...
bool ChatHandler::HandleWorldMailCommand(char* args)
{
	if (!*args)
		return false;
	Player* player = m_session->GetPlayer();
	...
	sWorld.PlayerWorldMailGuid(items, player, msgSubject, msgText);
	return true;
}

bool ChatHandler::HandleJuBaoCommand(char* args)
{
	//Player* player = getSelectedPlayer();
	char* cnameOrIP = ExtractArg(&args);
	if (!cnameOrIP)
	...
	if (!normalizePlayerName(nameOrIP))
	{
		SendSysMessage(LANG_JUBAO_1);
		SetSentErrorMessage(true);
		return false;
	}
	QueryResult* resultguid = CharacterDatabase.PQuery("SELECT guid FROM characters WHERE name = '%s'", nameOrIP.c_str());
	Player* playera = m_session->GetPlayer();
	if (!resultguid || !playera)
	{
		SendSysMessage(LANG_JUBAO_1);
		SetSentErrorMessage(true);
		return false;
	...
	Field* fieldsnage = resultguid->Fetch();
	uint32 guid = fieldsnage->GetUInt32();
	ObjectGuid playerguid = ObjectGuid(HIGHGUID_PLAYER, guid);
	Player* player = sObjectMgr.GetPlayer(playerguid);
	if (!player)
	{
		SendSysMessage(LANG_JUBAO_9);
		SetSentErrorMessage(true);
		return false;
	}

	BattleGround* bg = player->GetBattleGround();
	BattleGround* bga = playera->GetBattleGround();
	if (!bg || !bga)
	{
		SendSysMessage(LANG_JUBAO_2);
		SetSentErrorMessage(true);
		return false;
	}
	...
	if (player == playera)
	{
		SendSysMessage(LANG_JUBAO_8);
		SetSentErrorMessage(true);
		return false;
	}

	QueryResult* result = LoginDatabase.PQuery("SELECT player, cont, player1, player2, player3, jubaocont FROM characters_battleground_jiance WHERE guid = %u", player->GetGUIDLow());
	if (!result)
	{
		SendSysMessage(LANG_JUBAO_3);
		SetSentErrorMessage(true);
		return false;
	}

	Field *fields = result->Fetch();
	std::string par = fields[0].GetString();
	uint32 cont = fields[1].GetUInt32();
	uint32 player1 = fields[2].GetUInt32();
	uint32 player2 = fields[3].GetUInt32();
	uint32 player3 = fields[4].GetUInt32();
	uint32 jubaocont = fields[5].GetUInt32();
	if (cont < 3)
	{
		SendSysMessage(LANG_JUBAO_7);
		SetSentErrorMessage(true);
		delete result;
		return false;
	}
	if (player1 == playera->GetGUIDLow() || player2 == playera->GetGUIDLow() || player3 == playera->GetGUIDLow())
	{
		ChatHandler(playera).PSendSysMessage(LANG_JUBAO_4, jubaocont);
		SetSentErrorMessage(true);
		delete result;
		return false;
	}
	if (jubaocont == 0 && player1 == 0)
	{
		LoginDatabase.PExecute("UPDATE characters_battleground_jiance SET player1 = %u, jubaocont = %u WHERE guid = %u", playera->GetGUIDLow(), jubaocont += 1, player->GetGUIDLow());
		ChatHandler(playera).PSendSysMessage(LANG_JUBAO_5, player->GetName(), jubaocont);
	}
	else
	if (jubaocont == 1 && player1 != 0 && player2 == 0)
	{
		LoginDatabase.PExecute("UPDATE characters_battleground_jiance SET player2 = %u, jubaocont = %u WHERE guid = %u", playera->GetGUIDLow(), jubaocont += 1, player->GetGUIDLow());
		ChatHandler(playera).PSendSysMessage(LANG_JUBAO_5, player->GetName(), jubaocont);
	}
	else
	if (jubaocont == 2 && player1 != 0 && player2 != 0 && player3 == 0)
	{
		LoginDatabase.PExecute("UPDATE characters_battleground_jiance SET player3 = %u, jubaocont = %u WHERE guid = %u", playera->GetGUIDLow(), jubaocont += 1, player->GetGUIDLow());
		if (cont >= 3 && jubaocont >= 3)
		{
			ChatHandler(playera).PSendSysMessage(LANG_JUBAO_6, player->GetName(), jubaocont);
			static SqlStatementID insertJiancea;
			SqlStatement stmta = CharacterDatabase.CreateStatement(insertJiancea, "DELETE FROM account_banned WHERE id = ?");
			stmta.addUInt32(player->GetSession()->GetAccountId());
			stmta.Execute();
			LoginDatabase.PExecute("INSERT INTO account_banned VALUES ('%u', UNIX_TIMESTAMP(), UNIX_TIMESTAMP()+%u, 'BattleGround', '%s', '1')", player->GetSession()->GetAccountId(), 172800, player->GetName());
			player->GetSession()->KickPlayer();
			...
			stmt.addUInt64(player->GetGUIDLow());
			stmt.Execute();
			MapEntry const* mapEntry = sMapStore.LookupEntry(player->GetMapId());
			sLog.outBattleGround("[%s], Player = %s, Player1 = %u, Player2 = %u, Player3 = %u", (mapEntry ? mapEntry->name[player->GetSession()->GetSessionDbcLocale()] : "<unknown>"), par.c_str(), player1, player2, playera->GetGUIDLow());
		}
	}
...
/*bool ChatHandler::HandleYqZyCommand(char* args)
{
	if (!*args)
        return false;
	...
	int32 guid;
    if (!ExtractInt32(&args, guid))
        return false;

	int32 cont;
    if (!ExtractInt32(&args, cont))
        return false;

	if (cont <= 0 || cont > 5)
	{
        SendSysMessage(LANG_ZHANYOU_1);
        SetSentErrorMessage(true);
        return false;
    }
	...
	{
        SendSysMessage(LANG_ZHANYOU_4);
        SetSentErrorMessage(true);
        return false;
	}

	if (player->m_Player_GongNeng[PLAYED_ZHANYOU_FLAGS] == 2)
	{
	    SendSysMessage(LANG_ZHANYOU_5);
        SetSentErrorMessage(true);
        return false;
	}

	if (target->m_Player_GongNeng[PLAYED_ZHANYOU_FLAGS] >= 1)
	{
		SendSysMessage(LANG_ZHANYOU_6);
        SetSentErrorMessage(true);
        return false;
	}

	if (player->GetGUIDLow() == target->GetGUIDLow())
	{
        SendSysMessage(LANG_ZHANYOU_7);
        SetSentErrorMessage(true);
        return false;
	}

	if (guid != target->GetGUIDLow())
	{
        SendSysMessage(LANG_ZHANYOU_8);
        SetSentErrorMessage(true);
        return false;
	}
	...
	if (cont == 1)
	{
	    if (player->GetGongNeng(12) >= 2)
		{
			SendSysMessage(LANG_ZHANYOU_9);
            SetSentErrorMessage(true);
            return false;
		}

	    player->SetGongNeng(target->GetGUIDLow(), 12);
		target->SetGongNeng(player->GetGUIDLow(), 12);
	}
	else
	if (cont == 2)
	{
		if (player->GetGongNeng(13) >= 2)
		{
			SendSysMessage(LANG_ZHANYOU_10);
            SetSentErrorMessage(true);
            return false;
		}

	    player->SetGongNeng(target->GetGUIDLow(), 13);
		target->SetGongNeng(player->GetGUIDLow(), 13);
	}
	else
	if (cont == 3)
	{
		if (player->GetGongNeng(14) >= 2)
		{
			SendSysMessage(LANG_ZHANYOU_11);
            SetSentErrorMessage(true);
            return false;
		}

	    player->SetGongNeng(target->GetGUIDLow(), 14);
		target->SetGongNeng(player->GetGUIDLow(), 14);
	}
	else
	if (cont == 4)
	{
		if (player->GetGongNeng(15) >= 2)
		{
			SendSysMessage(LANG_ZHANYOU_12);
            SetSentErrorMessage(true);
            return false;
		}

	    player->SetGongNeng(target->GetGUIDLow(), 15);
		target->SetGongNeng(player->GetGUIDLow(), 15);
	}
	else
	if (cont == 5)
	{
		if (player->GetGongNeng(16) >= 2)
		{
			SendSysMessage(LANG_ZHANYOU_13);
            SetSentErrorMessage(true);
            return false;
		}

	    player->SetGongNeng(target->GetGUIDLow(), 16);
		target->SetGongNeng(player->GetGUIDLow(), 16);
	}

	if (player->m_Player_GongNeng[PLAYED_ZHANYOU_FLAGS] < 1)
	{
	    player->m_Player_GongNeng[PLAYED_ZHANYOU_FLAGS] = 1;
		player->m_Player_time[PLAYER_TIME_ZHANYOU] = 0;
	}
	if (target->m_Player_GongNeng[PLAYED_ZHANYOU_FLAGS] < 1)
	{
        target->m_Player_GongNeng[PLAYED_ZHANYOU_FLAGS] = 2;
		target->m_Player_time[PLAYER_TIME_ZHANYOU] = 0;
	}

	QueryResult* resulta = CharacterDatabase.PQuery("SELECT name FROM characters WHERE guid = %u", target->GetGUIDLow());
	if (resulta)
	{
		Field* fields = resulta->Fetch();
		std::string name = fields[0].GetCppString();
	    ChatHandler(player).PSendSysMessage(LANG_ZHANYOU_14, name.c_str());
	}
	QueryResult* resultb = CharacterDatabase.PQuery("SELECT name FROM characters WHERE guid = %u", player->GetGUIDLow());
	if (resultb)
	{
		Field* fields = resultb->Fetch();
		std::string name = fields[0].GetCppString();
	    ChatHandler(target).PSendSysMessage(LANG_ZHANYOU_15, name.c_str());
	}
	player->SaveToDB();
	target->SaveToDB();
...
bool ChatHandler::HandleQxZyCommand(char* args)
{
	if (!*args)
        return false;
	...
	if (player->m_Player_GongNeng[PLAYED_ZHANYOU_FLAGS] == 0)
	{
	    SendSysMessage(LANG_QUXIAOZHANYOU_1);
        SetSentErrorMessage(true);
        return false;
	}
	...
	if (cont <= 0 || cont > 5)
	{
        SendSysMessage(LANG_QUXIAOZHANYOU_2);
        SetSentErrorMessage(true);
        return false;
    }
	...
	if (player->m_Player_GongNeng[PLAYED_ZHANYOU_FLAGS] == 1)
	{
		uint32 money = 5000000;
		if (player->GetMoney() < money)
		{
			sGet.MoneyXianShi(player, money);
            SetSentErrorMessage(true);
            return false;
		}
		uint32 huoli = 60;
		if (player->GetGongNeng(9) < huoli)
		{
			ChatHandler(player).PSendSysMessage(LANG_QUXIAOZHANYOU_4, huoli);
            SetSentErrorMessage(true);
            return false;
		}
		uint32 guid = 0;
	    if (cont == 1)
		{
			guid = player->GetGongNeng(12);
			QueryResult* result1 = CharacterDatabase.PQuery("SELECT zhanyouguid1 FROM characters_gongneng WHERE guid = %u", player->GetGUIDLow());
			QueryResult* result2 = CharacterDatabase.PQuery("SELECT zhanyouguid1 FROM characters_gongneng WHERE guid = %u", guid);
		    if (result1)
		    {
			    Field *fields = result1->Fetch();
		        uint32 guid1 = fields[0].GetUInt32();
				if (guid1 < 2)
				{
					SendSysMessage(LANG_QUXIAOZHANYOU_6);
                    SetSentErrorMessage(true);
                    return false;
				}
				if (result2)
				{
		            ...
		            uint32 guid2 = fields[0].GetUInt32();
					if (player->GetGUIDLow() != guid2)
					{
					    SendSysMessage(LANG_QUXIAOZHANYOU_11);
                        SetSentErrorMessage(true);
                        return false;
				    }
					ObjectGuid getguid = ObjectGuid(HIGHGUID_PLAYER, guid);
				    Player* playere = sObjectMgr.GetPlayer(getguid);
					if (playere)
					{
						playere->m_Player_GongNeng[PLAYED_ZHANYOU_FLAGS] = 0;
						playere->m_Player_time[PLAYER_TIME_ZHANYOU] = 0;
						playere->SaveToDB();
					    LoginDatabase.PExecute("UPDATE characters_gongneng SET zhanyouguid1 = '%u', zhanyoulevel1 = '%u' WHERE guid = '%u'",1, 0, guid);
		                LoginDatabase.CommitTransaction();
					}
					else
					{
						LoginDatabase.PExecute("UPDATE characters_gongneng SET zhanyouguid1 = '%u', zhanyougFlags = '%u', zhanyougtime = '%u', zhanyoulevel1 = '%u' WHERE guid = '%u'",1, 0, 0, 0, guid);
		                LoginDatabase.CommitTransaction();
					}
				}
				else
					SendSysMessage(LANG_QUXIAOZHANYOU_16);
			}
			player->SetGongNeng(1, 12);
			player->SetGongNeng(0, 19);
		}
		if (cont == 2)
		{
			guid = player->GetGongNeng(13);
			QueryResult* result1 = CharacterDatabase.PQuery("SELECT zhanyouguid2 FROM characters_gongneng WHERE guid = %u", player->GetGUIDLow());
			QueryResult* result2 = CharacterDatabase.PQuery("SELECT zhanyouguid2 FROM characters_gongneng WHERE guid = %u", guid);
		    if (result1)
		    {
			    Field *fields = result1->Fetch();
		        uint32 guid1 = fields[0].GetUInt32();
				if (guid1 < 2)
				{
					SendSysMessage(LANG_QUXIAOZHANYOU_7);
                    SetSentErrorMessage(true);
                    return false;
				}
				if (result2)
				{
					...
					if (player->GetGUIDLow() != guid2)
					{
					    SendSysMessage(LANG_QUXIAOZHANYOU_12);
                        SetSentErrorMessage(true);
                        return false;
				    }
					...
					if (playere)
					{
						...
						playere->m_Player_time[PLAYER_TIME_ZHANYOU] = 0;
						playere->SaveToDB();
					    LoginDatabase.PExecute("UPDATE characters_gongneng SET zhanyouguid2 = '%u', zhanyoulevel2 = '%u' WHERE guid = '%u'",1, 0, guid);
		                LoginDatabase.CommitTransaction();
					}
					else
					{
						LoginDatabase.PExecute("UPDATE characters_gongneng SET zhanyouguid2 = '%u', zhanyougFlags = '%u', zhanyougtime = '%u', zhanyoulevel2 = '%u' WHERE guid = '%u'",1, 0, 0, 0, guid);
		                LoginDatabase.CommitTransaction();
					}
			...
			player->SetGongNeng(1, 13);
			player->SetGongNeng(0, 20);
		}
		if (cont == 3)
		{
			guid = player->GetGongNeng(14);
			QueryResult* result1 = CharacterDatabase.PQuery("SELECT zhanyouguid3 FROM characters_gongneng WHERE guid = %u", player->GetGUIDLow());
			QueryResult* result2 = CharacterDatabase.PQuery("SELECT zhanyouguid3 FROM characters_gongneng WHERE guid = %u", guid);
		    if (result1)
		    {
			    Field *fields = result1->Fetch();
		        uint32 guid1 = fields[0].GetUInt32();
				if (guid1 < 2)
				{
					SendSysMessage(LANG_QUXIAOZHANYOU_8);
                    SetSentErrorMessage(true);
                    return false;
				}
				if (result2)
				{
					...
					if (player->GetGUIDLow() != guid2)
					{
					    SendSysMessage(LANG_QUXIAOZHANYOU_13);
                        SetSentErrorMessage(true);
                        return false;
				    }
					...
					if (playere)
					{
						...
						playere->m_Player_time[PLAYER_TIME_ZHANYOU] = 0;
						playere->SaveToDB();
					    LoginDatabase.PExecute("UPDATE characters_gongneng SET zhanyouguid3 = '%u', zhanyoulevel3 = '%u' WHERE guid = '%u'",1, 0, guid);
		                LoginDatabase.CommitTransaction();
					}
					else
					{
						LoginDatabase.PExecute("UPDATE characters_gongneng SET zhanyouguid3 = '%u', zhanyougFlags = '%u', zhanyougtime = '%u', zhanyoulevel3 = '%u' WHERE guid = '%u'",1, 0, 0, 0, guid);
		                LoginDatabase.CommitTransaction();
					}
				}
				else
			...
			player->SetGongNeng(1, 14);
			player->SetGongNeng(0, 21);
		}
		if (cont == 4)
		{
			guid = player->GetGongNeng(15);
			QueryResult* result1 = CharacterDatabase.PQuery("SELECT zhanyouguid4 FROM characters_gongneng WHERE guid = %u", player->GetGUIDLow());
			QueryResult* result2 = CharacterDatabase.PQuery("SELECT zhanyouguid4 FROM characters_gongneng WHERE guid = %u", guid);
		    if (result1)
		    {
			    Field *fields = result1->Fetch();
		        uint32 guid1 = fields[0].GetUInt32();
				if (guid1 < 2)
				{
					SendSysMessage(LANG_QUXIAOZHANYOU_9);
                    SetSentErrorMessage(true);
                    return false;
				}
				if (result2)
				{
					...
					if (player->GetGUIDLow() != guid2)
					{
					    SendSysMessage(LANG_QUXIAOZHANYOU_14);
                        SetSentErrorMessage(true);
                        return false;
				    }
					...
					if (playere)
					{
						...
						playere->m_Player_time[PLAYER_TIME_ZHANYOU] = 0;
						playere->SaveToDB();
					    LoginDatabase.PExecute("UPDATE characters_gongneng SET zhanyouguid4 = '%u', zhanyoulevel4 = '%u' WHERE guid = '%u'",1, 0, guid);
		                LoginDatabase.CommitTransaction();
					}
					else
					{
						LoginDatabase.PExecute("UPDATE characters_gongneng SET zhanyouguid4 = '%u', zhanyougFlags = '%u', zhanyougtime = '%u', zhanyoulevel4 = '%u' WHERE guid = '%u'",1, 0, 0, 0, guid);
		                LoginDatabase.CommitTransaction();
					}
			...
			player->SetGongNeng(1, 15);
			player->SetGongNeng(0, 22);
		}
		if (cont == 5)
		{
			guid = player->GetGongNeng(16);
			QueryResult* result1 = CharacterDatabase.PQuery("SELECT zhanyouguid5 FROM characters_gongneng WHERE guid = %u", player->GetGUIDLow());
			QueryResult* result2 = CharacterDatabase.PQuery("SELECT zhanyouguid5 FROM characters_gongneng WHERE guid = %u", guid);
		    if (result1)
		    {
			    Field *fields = result1->Fetch();
		        uint32 guid1 = fields[0].GetUInt32();
				if (guid1 < 2)
				{
					SendSysMessage(LANG_QUXIAOZHANYOU_10);
                    SetSentErrorMessage(true);
                    return false;
				}
				if (result2)
				{
					...
					if (player->GetGUIDLow() != guid2)
					{
					    SendSysMessage(LANG_QUXIAOZHANYOU_15);
                        SetSentErrorMessage(true);
                        return false;
				    }
					...
					if (playere)
					{
						...
						playere->m_Player_time[PLAYER_TIME_ZHANYOU] = 0;
						playere->SaveToDB();
					    LoginDatabase.PExecute("UPDATE characters_gongneng SET zhanyouguid5 = '%u', zhanyoulevel5 = '%u' WHERE guid = '%u'",1, 0, guid);
		                LoginDatabase.CommitTransaction();
					}
					else
					{
						LoginDatabase.PExecute("UPDATE characters_gongneng SET zhanyouguid5 = '%u', zhanyougFlags = '%u', zhanyougtime = '%u', zhanyoulevel5 = '%u' WHERE guid = '%u'",1, 0, 0, 0, guid);
		                LoginDatabase.CommitTransaction();
					}
			...
			player->SetGongNeng(1, 16);
			player->SetGongNeng(0, 23);
		}

		QueryResult* resulta = CharacterDatabase.PQuery("SELECT name FROM characters WHERE guid = %u", guid);
	    if (resulta)
	    {
		    Field* fields = resulta->Fetch();
		    std::string name = fields[0].GetCppString();
	        ChatHandler(player).PSendSysMessage(LANG_QUXIAOZHANYOU_5, name.c_str());
	    }

		uint32 cont = 0;
		for (uint32 i = 12; i <= 16; ++i )
             if (player->GetGongNeng(i) < 2)
				 ++cont;

		if (cont >= 4)
			player->m_Player_GongNeng[PLAYED_ZHANYOU_FLAGS] = 0;

		player->SetGongNeng(player->GetGongNeng(9) - huoli, 9);
		player->SetGongNeng(0, 18);
        uint32 Money = player->GetMoney() - money;
		player->SetMoney(Money);
		ObjectGuid playerid = ObjectGuid(HIGHGUID_PLAYER, guid);
		Player* playera = sObjectMgr.GetPlayer(playerid);
		if (playera)
			ChatHandler(playera).PSendSysMessage(LANG_QUXIAOZHANYOU_22, player->GetName(), player->GetName());
	}
	...
	if (player->m_Player_GongNeng[PLAYED_ZHANYOU_FLAGS] == 2)
	{
		...
		QueryResult* result = CharacterDatabase.PQuery("SELECT zhanyouguid1, zhanyouguid2, zhanyouguid3, zhanyouguid4, zhanyouguid5 FROM characters_gongneng WHERE guid = %u", guid);
		if (result)
		{
			uint32 cont = 0;
			Field *fields = result->Fetch();
			...
			{
                 uint32 zhanyouguid = fields[i].GetUInt32();
				 if (zhanyouguid < 2)
				     ++cont;
			}
			...
			if (cont >= 4)
			{
				...
				{
				    LoginDatabase.PExecute("UPDATE characters_gongneng SET zhanyougFlags = '%u' WHERE guid = '%u'", 0, guid);
		            LoginDatabase.CommitTransaction();
				}
			}
		}
...
bool ChatHandler::HandleCxZyCommand(char* args)
{
	Player* player = m_session->GetPlayer();
	uint32 cont = 0;
	if (player->m_Player_GongNeng[PLAYED_ZHANYOU_FLAGS] == 2)
	{
		QueryResult* result = CharacterDatabase.PQuery("SELECT zhanyouguid1, zhanyouguid2, zhanyouguid3, zhanyouguid4, zhanyouguid5 FROM characters_gongneng WHERE guid = %u", player->GetGUIDLow());
	    if (result)
        {
		    Field *fields = result->Fetch();
		    for (uint32 i = 0; i <= 4; ++i )
		    {
			     ...
			     if (zhanyouguid >= 2)
			     {
				     QueryResult* result = CharacterDatabase.PQuery("SELECT name, race, class, level, online FROM characters WHERE guid = %u", zhanyouguid);
				     if (result)
				     {
					        Field* fields = result->Fetch();
                            std::string name = fields[0].GetCppString();
							...
							uint32 online     = fields[4].GetUInt32();
							...
							if (online == 1)
						        ChatHandler(player).PSendSysMessage(LANG_QUXIAOZHANYOU_19, name.c_str(), name.c_str(), race_name, class_name, level);
							else
								ChatHandler(player).PSendSysMessage(LANG_QUXIAOZHANYOU_21, name.c_str(), name.c_str(), race_name, class_name, level);
				     }
			     }
		     }
         }
		 if (cont >= 5)
		     ChatHandler(player).PSendSysMessage(LANG_QUXIAOZHANYOU_18);
	...
	if (result)
    {
		...
		for (uint32 i = 0; i <= 4; ++i )
		{
			 ...
			 if (zhanyouguid >= 2)
			 {
				 QueryResult* result1 = CharacterDatabase.PQuery("SELECT name, race, class, level, online FROM characters WHERE guid = %u", zhanyouguid);
				 QueryResult* result2 = CharacterDatabase.PQuery("SELECT zhanyougtime FROM characters_gongneng WHERE guid = %u", zhanyouguid);
				 QueryResult* result3 = CharacterDatabase.PQuery("SELECT zhanyoulevel1, zhanyoulevel2, zhanyoulevel3, zhanyoulevel4, zhanyoulevel5 FROM characters_gongneng WHERE guid = %u", zhanyouguid);
				 if (result1 || result2 || result3)
				 {
						...
						std::string Online;
						uint32 zhanyougtime = 0;
                        std::string name = fields1[0].GetCppString();
                        uint32 race       = fields1[1].GetUInt32();
                        uint32 class_     = fields1[2].GetUInt32();
                        uint32 level     = fields1[3].GetUInt32();
						uint32 online     = fields1[4].GetUInt32();
						uint32 zhanyoulevel = fields3[i].GetUInt32();
						ObjectGuid guid = ObjectGuid(HIGHGUID_PLAYER, zhanyouguid);
				        Player* playera = sObjectMgr.GetPlayer(guid);
						if (playera)
						    zhanyougtime = playera->m_Player_time[PLAYER_TIME_ZHANYOU];
						else
							zhanyougtime = fields2[0].GetUInt32();
						uint32 secs    = zhanyougtime % MINUTE;
                        uint32 minutes = zhanyougtime % HOUR / MINUTE;
                        uint32 hours   = zhanyougtime % DAY  / HOUR;
						ChrRacesEntry const* raceEntry = sChrRacesStore.LookupEntry(race);
                        ChrClassesEntry const* classEntry = sChrClassesStore.LookupEntry(class_);
						...
						if (online == 1)
						    ChatHandler(player).PSendSysMessage(LANG_QUXIAOZHANYOU_17, i + 1, name.c_str(), name.c_str(), race_name, class_name, level, hours, minutes, secs, zhanyoulevel);
						else
							ChatHandler(player).PSendSysMessage(LANG_QUXIAOZHANYOU_20, i + 1, name.c_str(), name.c_str(), race_name, class_name, level, hours, minutes, secs, zhanyoulevel);
				 }
			 }
			 else
				 ++cont;
...
bool ChatHandler::HandleLiBaoCommand(char* args)
{
	if (!*args)
		return false;
	Player* player = m_session->GetPlayer();
	if (!player->PlayerLeaderGuid())
	{
		SendSysMessage(LANG_GUIID_2);
		SetSentErrorMessage(true);
		return false;
	}

	if (sWorld.getConfig(CONFIG_BOOL_SAFE_LOCK) && player->GetPlayerSafe() == 0)
	{
		SendSysMessage(LANG_SAFE_20);
		SetSentErrorMessage(true);
		return false;
	}

	Player* pTarget;
	if (!ExtractPlayerTarget(&args, &pTarget))
		return false;

	if (pTarget->GetVip(22) > 0)
	{
		SendSysMessage(LANG_GUIID_12);
		SetSentErrorMessage(true);
		return false;
	}

	if (player->GetGuildId() != pTarget->GetGuildId())
	{
		SendSysMessage(LANG_GUIID_8);
		SetSentErrorMessage(true);
		return false;
	}

	if (player->GetPlayerGuiIdMianFei() >= 1)
	{
		MailDraft(170).SendMailTo(pTarget, player, MAIL_CHECK_MASK_HAS_BODY, 5);
		player->m_Player_GuiId[PLAYED_GUIID_MIANFEI] -= 1;
		pTarget->SetVip(1, 22);
		player->SaveToDB();
		ChatHandler(player).PSendSysMessage(LANG_GUIID_9, player->m_Player_GuiId[PLAYED_GUIID_MIANFEI]);
	}
	else
	if (player->GetPlayerGuiIdShouFei() >= 1)
	{
		MailDraft(170).SendMailTo(pTarget, player, MAIL_CHECK_MASK_HAS_BODY, 5);
		player->m_Player_GuiId[PLAYED_GUIID_SHOUFEI] -= 1;
		pTarget->SetVip(1, 22);
		player->SaveToDB();
		ChatHandler(player).PSendSysMessage(LANG_GUIID_11, player->m_Player_GuiId[PLAYED_GUIID_SHOUFEI]);
	}
	else
	{
		SendSysMessage(LANG_GUIID_10);
		SetSentErrorMessage(true);
		return false;
	}
	return true;
...
bool ChatHandler::HandleSafeSetpwCommand(char* args)
{
	if (!sWorld.getConfig(CONFIG_BOOL_SAFE_LOCK))
	{
		SendSysMessage(LANG_SAFE_21);
		SetSentErrorMessage(true);
		return false;
	}
	///- Get the command line arguments
	...
	if (player->GetSafePass() != "a")
	{
		SendSysMessage(LANG_SAFE_1);
		SetSentErrorMessage(true);
		return false;
	}

	uint32 targetAccountId = player->GetSession()->GetAccountId();
	...
	da1 = szPassword1;
	da2 = szPassword2;
	if (utf8length(da1) < 6 || utf8length(da1) > 6 || utf8length(da2) < 6 || utf8length(da2) > 6)
	{
		SendSysMessage(LANG_SAFE_22);
		SetSentErrorMessage(true);
		return false;
	}

	sAccountMgr.SafePassword(targetAccountId, szPassword1);
	SendSysMessage(LANG_SAFE_4);
	return true;
}

bool ChatHandler::HandleSafeLockCommand(char* args)
{
	if (!sWorld.getConfig(CONFIG_BOOL_SAFE_LOCK))
	{
		SendSysMessage(LANG_SAFE_21);
	...
	if (player->GetPlayerSafe() == 0)
	{
		SendSysMessage(LANG_SAFE_17);
		SetSentErrorMessage(true);
		return false;
	}
	if (!szPassword)
	{
		SendSysMessage(LANG_SAFE_5);
		SetSentErrorMessage(true);
		return false;
	}
	if (player->GetSafePass() != sAccountMgr.GetePassword(targetAccountId, szPassword))
	{
		SendSysMessage(LANG_SAFE_6);
		SetSentErrorMessage(true);
		return false;
	}
	player->m_Player_SAFE[PLAYER_SAFE] = 0;
	SendSysMessage(LANG_SAFE_7);
	player->SaveToDB();
	return true;
}

bool ChatHandler::HandleSafeUnlockCommand(char* args)
{
	if (!sWorld.getConfig(CONFIG_BOOL_SAFE_LOCK))
	{
		SendSysMessage(LANG_SAFE_21);
	...
	uint32 targetAccountId = player->GetSession()->GetAccountId();
	char* szPassword = ExtractQuotedOrLiteralArg(&args);
	if (player->GetPlayerSafe() == 1 || player->GetPlayerSafe() == 2)
	{
		SendSysMessage(LANG_SAFE_18);
		SetSentErrorMessage(true);
		return false;
	}
	if (!szPassword)
	{
		SendSysMessage(LANG_SAFE_8);
		SetSentErrorMessage(true);
		return false;
	}
	if (player->GetSafePass() != sAccountMgr.GetePassword(targetAccountId, szPassword))
	{
		SendSysMessage(LANG_SAFE_9);
		SetSentErrorMessage(true);
		return false;
	}
	player->m_Player_SAFE[PLAYER_SAFE] = 1;
	SendSysMessage(LANG_SAFE_10);
	player->SaveToDB();
	return true;
}

bool ChatHandler::HandleSafeCloseCommand(char* args)
{
	if (!sWorld.getConfig(CONFIG_BOOL_SAFE_LOCK))
	{
		SendSysMessage(LANG_SAFE_21);
	...
	if (!player)
	{
		SendSysMessage(LANG_SAFE_12);
		SetSentErrorMessage(true);
		return false;
	}
	if (player->GetSafePass() == "a")
	{
		SendSysMessage(LANG_SAFE_19);
		SetSentErrorMessage(true);
		return false;
	}
	player->m_Player_SAFE[PLAYER_SAFE] = 2;
	SendSysMessage(LANG_SAFE_13);
	player->SaveToDB();
	return true;
}

bool ChatHandler::HandleSafeChpwCommand(char* args)
{
	if (!sWorld.getConfig(CONFIG_BOOL_SAFE_LOCK))
	{
		SendSysMessage(LANG_SAFE_21);
	...
	std::string da;
	da = szPassword;
	if (utf8length(da) < 6 || utf8length(da) > 6)
	{
		SendSysMessage(LANG_SAFE_22);
		SetSentErrorMessage(true);
		return false;
	...
	sAccountMgr.SafePassword(targetAccountId, szPassword);
	SendSysMessage(LANG_SAFE_16);
	return true;
}

bool ChatHandler::HandleYcCommand(char* args)
{
	Player* player = m_session->GetPlayer();
	if (!player)
	{
		SendSysMessage(LANG_GONGGAO_21);
		SetSentErrorMessage(true);
		return false;
	}
	if (!player->CanPlayerSpeak())
	{
		std::string timeStr = secsToTimeString(player->GetSession()->m_mutePlayerTime - time(NULL));
		ChatHandler(player).PSendSysMessage(LANG_WAIT_BEFORE_SPEAKING, timeStr.c_str());
		SetSentErrorMessage(true);
		return false;
	}

	player->UpdatePlayerSpeakTime();
	...
	QueryResult* result = LoginDatabase.PQuery("SELECT event FROM game_event_status WHERE event >= %u and event <= %u", 29, 32);
	if (result)
	{
		do
		{
			Field *fields = result->Fetch();
			uint32 _event = fields[0].GetUInt32();
			if (_event == 29)
				ChatHandler(player).PSendSysMessage(LANG_GONGGAO_22, player->GetZiZhiName(8888));
			else
			if (_event == 30)
				ChatHandler(player).PSendSysMessage(LANG_GONGGAO_22, player->GetZiZhiName(8889));
			else
			if (_event == 31)
				ChatHandler(player).PSendSysMessage(LANG_GONGGAO_22, player->GetZiZhiName(8890));
			else
			if (_event == 32)
				ChatHandler(player).PSendSysMessage(LANG_GONGGAO_22, player->GetZiZhiName(8891));
		}
		while (result->NextRow());
		delete result;
	}
	else
		ChatHandler(player).PSendSysMessage(LANG_GUIID_9);
	return true;
}

bool ChatHandler::HandleAplRankCommand(char* args)
{
	if (!sWorld.getConfig(CONFIG_BOOL_TAQ_KAIENRENWU))
	{
		SendSysMessage(LANG_TAQ_2);
		SetSentErrorMessage(true);
		return false;
	}
	...
	HonorStandingList AllPlayerList;
	AllPlayerList.clear();
	QueryResult* result = CharacterDatabase.PQuery("SELECT guid, jifen FROM characters_taq_jifen WHERE faction = %u", player->GetTeam());
	if (result)
	{
		do
		{
			Field* fields = result->Fetch();
			uint32 guid = fields[0].GetUInt32();
			uint32 jifen = fields[1].GetUInt32();
			Standing.guid = guid;
			Standing.honorPoints = float(jifen);
			AllPlayerList.push_back(Standing);
		}
	    while (result->NextRow());
	    delete result;

		AllPlayerList.sort();
		for (HonorStandingList::iterator itr = AllPlayerList.begin(); itr != AllPlayerList.end(); ++itr)
		{
			++cont;
			if (cont > 5)
				break;

			QueryResult* result = CharacterDatabase.PQuery("SELECT faction, name FROM characters_taq_jifen WHERE guid = %u", itr->guid);
			if (result)
			{
				Field* fields = result->Fetch();
				...
				PSendSysMessage(LANG_TAQ_4, cont, name.c_str(), player->GetPlayerTeam(faction), uint32(itr->honorPoints));
			}
		}
	}
	else
	{
		SendSysMessage(LANG_TAQ_12);
		SetSentErrorMessage(true);
		return false;
	}
...
bool ChatHandler::HandleAplWorldRankCommand(char* args)
{
	if (!sWorld.getConfig(CONFIG_BOOL_TAQ_KAIENRENWU))
	{
		SendSysMessage(LANG_TAQ_2);
	...
	HonorStandingList AllPlayerList;
	AllPlayerList.clear();
	QueryResult* result = CharacterDatabase.PQuery("SELECT guid, jifen FROM characters_taq_jifen WHERE guid > %u", 0);
	if (result)
	{
		do
		{
		...
		for (HonorStandingList::iterator itr = AllPlayerList.begin(); itr != AllPlayerList.end(); ++itr)
		{
			...
			if (result)
			{
				...
				PSendSysMessage(LANG_TAQ_5, cont, name.c_str(), player->GetPlayerTeam(faction), uint32(itr->honorPoints));
			}
		}
	}
	else
...
bool ChatHandler::HandleAplSelfCommand(char* args)
{
	if (!sWorld.getConfig(CONFIG_BOOL_TAQ_KAIENRENWU))
	{
		SendSysMessage(LANG_TAQ_2);
	...
	if (result)
	{
		...
		QueryResult* result = CharacterDatabase.PQuery("SELECT faction, name, jifen FROM characters_taq_jifen WHERE guid = %u", player->GetGUIDLow());
		if (result)
		{
			Field* fields = result->Fetch();
			uint32 faction = fields[0].GetUInt32();
			std::string name = fields[1].GetCppString();
			uint32 jifen = fields[2].GetUInt32();

			PSendSysMessage(LANG_TAQ_6, cont, name.c_str(), player->GetPlayerTeam(faction), jifen);
		}
	}
	else
	{
...
bool ChatHandler::HandleAplWuZhiCommand(char* args)
{
	if (!sWorld.getConfig(CONFIG_BOOL_TAQ_KAIENRENWU))
	{
		SendSysMessage(LANG_TAQ_2);
	...
	{
		QueryResult* result = LoginDatabase.PQuery("SELECT id, item_name, current_no, target_no FROM item_taq_wuzhi WHERE id <= %u", 8);
		if (result)
		{
			do
			{
				...
				std::string name = fields[1].GetCppString();
				uint32 current_no = fields[2].GetUInt32();
				uint32 target_no = fields[3].GetUInt32();
				if (id == 1)
					PSendSysMessage(LANG_TAQ_7, name.c_str(), player->MoneyXianShi(1, current_no), player->MoneyXianShi(2, current_no), player->MoneyXianShi(3, current_no), player->MoneyXianShi(1, target_no), player->MoneyXianShi(2, target_no), player->MoneyXianShi(3, target_no));
				else
					PSendSysMessage(LANG_TAQ_8, name.c_str(), current_no, target_no);
			} 
			while (result->NextRow());
			delete result;
		}
		...
		QueryResult* resulta = LoginDatabase.PQuery("SELECT id, item_name, current_no, target_no FROM item_taq_wuzhi WHERE id = %u", 20);
		if (resulta)
		{
			do
			{
	...
	{
		QueryResult* result = LoginDatabase.PQuery("SELECT id, item_name, current_no, target_no FROM item_taq_wuzhi WHERE id >= %u and id <= %u", 9, 16);
		if (result)
		{
			do
			{
				...
				uint32 target_no = fields[3].GetUInt32();
				if (id == 9)
					PSendSysMessage(LANG_TAQ_9, name.c_str(), player->MoneyXianShi(1, current_no), player->MoneyXianShi(2, current_no), player->MoneyXianShi(3, current_no), player->MoneyXianShi(1, target_no), player->MoneyXianShi(2, target_no), player->MoneyXianShi(3, target_no));
				else
				    PSendSysMessage(LANG_TAQ_10, name.c_str(), current_no, target_no);
			} 
			while (result->NextRow());
			delete result;
		}
		...
		QueryResult* resulta = LoginDatabase.PQuery("SELECT id, item_name, current_no, target_no FROM item_taq_wuzhi WHERE id = %u", 30);
		if (resulta)
		{
			do
			{
...
bool ChatHandler::HandleSfCommand(char* args)
{
	...
	if (player->getLevel() >= 60)
	{
		SendSysMessage(LANG_GONGGAO_24);
		SetSentErrorMessage(true);
		return false;
	}

	if (player->GetVip(27) >= 1)
	{
		player->SetVip(0, 27);
		SendSysMessage(LANG_GONGGAO_25);
	}
	else
	{
		player->SetVip(1, 27);
		SendSysMessage(LANG_GONGGAO_26);
	}

	return true;
}

bool ChatHandler::HandleThreatCommand(char* args)
{
	Player* player = m_session->GetPlayer();
	if (!player)
	{
		SendSysMessage(LANG_THREAT_1);
		SetSentErrorMessage(true);
		return false;
	}
	if (!sMapStore.LookupEntry(player->GetMapId())->IsDungeon())
	{
		SendSysMessage(LANG_THREAT_4);
		SetSentErrorMessage(true);
		return false;
	}
	uint32 cont = 0;
	...
	MaNGOS::AnyUnitInObjectRangeCheck go_check(player, radius);
	MaNGOS::CreatureListSearcher<MaNGOS::AnyUnitInObjectRangeCheck> go_search(creatureList, go_check);
	Cell::VisitGridObjects(player, go_search, radius);
	for (std::list<Creature*>::iterator itr = creatureList.begin(); itr != creatureList.end(); ++itr)
	{
		...
		++cont;
		ChatHandler(player).PSendSysMessage(LANG_THREAT_2, cont, (*itr)->GetName(), (*itr)->GetMapId(), (*itr)->GetPositionX(), (*itr)->GetPositionY(), (*itr)->GetPositionZ());
	}

	Group* pGroup = player->GetGroup();
	if (pGroup && pGroup->IsLeader(player->GetObjectGuid()))
	{
		for (GroupReference* itr = pGroup->GetFirstMember(); itr != NULL; itr = itr->next())
		{
			Player* pGroupie = itr->getSource();
			if (!pGroupie || pGroupie->isDead() || (player->GetInstanceId() != pGroupie->GetInstanceId()))
				continue;

			Pet* pPet = pGroupie->GetPet();
			if (!pPet || !pPet->isInCombat())
				continue;

			++cont;
			ChatHandler(player).PSendSysMessage(LANG_THREAT_2, cont, pPet->GetName(), pPet->GetMapId(), pPet->GetPositionX(), pPet->GetPositionY(), pPet->GetPositionZ());
		}
	}
	if (cont == 0)
	{
		SendSysMessage(LANG_THREAT_3);
		SetSentErrorMessage(true);
		return false;
	}
	return true;
...
bool ChatHandler::HandleGpdebugOnCommand(char* args)
{
	int32 cout;
	if (ExtractInt32(&args, cout))
	{
		if (cout == 0)
			sWorld.Worldsdebug = false;
		else
		if (cout == 1)
			sWorld.Worldsdebug = true;
	}
	return true;
}

bool ChatHandler::HandleGpdebugCxCommand(char* args)
{
	Player* player = m_session->GetPlayer();
	int32 groupNr;
	ExtractInt32(&args, groupNr);
	Group* pGroup = player->GetGroup();
	if (!player || !pGroup || groupNr > 7 || !pGroup->isRaidGroup() || !pGroup->IsLeader(player->GetObjectGuid()))
	{
		SetSentErrorMessage(true);
		return false;
	}
	if (pGroup->GetSubGroupsCounts(uint8(groupNr)))
	{
		ChatHandler(player).PSendSysMessage(LANG_GROUP_1, pGroup->GetSubGroupsCounts(uint8(groupNr)));
		for (Group::member_citerator itr = pGroup->GetMemberSlots().begin(); itr != pGroup->GetMemberSlots().end(); ++itr)
		{
			if (!itr->guid)
				continue;

			if (itr->group == uint8(groupNr))
				ChatHandler(player).PSendSysMessage(LANG_GROUP_2, itr->group, itr->name);
		}
	}
...
bool ChatHandler::HandleDestroyCommand(char* args)
{
	Player* player = m_session->GetPlayer();
	int32 groupNr;
	GuidList m_lGroupList;
	m_lGroupList.clear();
	ExtractInt32(&args, groupNr);
	Group* pGroup = player->GetGroup();
	if (!player || !pGroup || groupNr > 7 || !pGroup->isRaidGroup() || !pGroup->IsLeader(player->GetObjectGuid()))
	...
	for (Group::member_citerator itr = pGroup->GetMemberSlots().begin(); itr != pGroup->GetMemberSlots().end(); ++itr)
	{
		...
		if (itr->group == uint8(groupNr))
			m_lGroupList.push_back(itr->guid);
	}

	for (GuidList::const_iterator itr = m_lGroupList.begin(); itr != m_lGroupList.end(); ++itr)
	{
		if (!(*itr))
			continue;

		pGroup->RemoveMember(*itr, 0);
	}
	
	return true;
}

bool ChatHandler::HandleChouhenDebugCommand(char* args)
{
	Player* player = m_session->GetPlayer();
	if (!player)
	{
	...
	{
		if (cout == 0)
			player->setChouhenDebug(false);
		else
		if (cout == 1)
			player->setChouhenDebug(true);
	}
	return true;
}
...
bool ChatHandler::HandleModifyJfCommand(char * args)//»ý·Öº¯ÊýÌå
{
	if (!*args)
		return false;
	Player *target = getSelectedPlayer();
