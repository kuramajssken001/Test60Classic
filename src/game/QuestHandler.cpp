...
void WorldSession::HandleQuestgiverRequestRewardOpcode(WorldPacket& recv_data)
{
	...
	if (sWorld.getConfig(CONFIG_BOOL_TAQ_KAIENRENWU))
	{
		...
		case 8492:
		case 8493:
			if (sWorld.GetTaqWuZhi(1, 1) >= sWorld.GetTaqWuZhi(1, 2))
			{
				ChatHandler(_player).PSendSysMessage(LANG_TAQ_1);
				return;
			}
			break;
		case 8494:
		case 8495:
			if (sWorld.GetTaqWuZhi(2, 1) >= sWorld.GetTaqWuZhi(2, 2))
			{
				ChatHandler(_player).PSendSysMessage(LANG_TAQ_1);
				return;
			}
		...
		case 8499:
		case 8500:
			if (sWorld.GetTaqWuZhi(3, 1) >= sWorld.GetTaqWuZhi(3, 2))
			{
				ChatHandler(_player).PSendSysMessage(LANG_TAQ_1);
				return;
			}
		...
		case 8505:
		case 8506:
			if (sWorld.GetTaqWuZhi(4, 1) >= sWorld.GetTaqWuZhi(4, 2))
			{
				ChatHandler(_player).PSendSysMessage(LANG_TAQ_1);
				return;
			}
		...
		case 8509:
		case 8510:
			if (sWorld.GetTaqWuZhi(5, 1) >= sWorld.GetTaqWuZhi(5, 2))
			{
				ChatHandler(_player).PSendSysMessage(LANG_TAQ_1);
				return;
			}
		...
		case 8513:
		case 8514:
			if (sWorld.GetTaqWuZhi(6, 1) >= sWorld.GetTaqWuZhi(6, 2))
			{
				ChatHandler(_player).PSendSysMessage(LANG_TAQ_1);
				return;
			}
		...
		case 8517:
		case 8518:
			if (sWorld.GetTaqWuZhi(7, 1) >= sWorld.GetTaqWuZhi(7, 2))
			{
				ChatHandler(_player).PSendSysMessage(LANG_TAQ_1);
				return;
			}
		...
		case 8522:
		case 8523:
			if (sWorld.GetTaqWuZhi(8, 1) >= sWorld.GetTaqWuZhi(8, 2))
			{
				ChatHandler(_player).PSendSysMessage(LANG_TAQ_1);
				return;
			}
		...
		case 8532:
		case 8533:
			if (sWorld.GetTaqWuZhi(9, 1) >= sWorld.GetTaqWuZhi(9, 2))
			{
				ChatHandler(_player).PSendSysMessage(LANG_TAQ_1);
				return;
			}
		...
		case 8545:
		case 8546:
			if (sWorld.GetTaqWuZhi(10, 1) >= sWorld.GetTaqWuZhi(10, 2))
			{
				ChatHandler(_player).PSendSysMessage(LANG_TAQ_1);
				return;
			}
		...
		case 8549:
		case 8550:
			if (sWorld.GetTaqWuZhi(11, 1) >= sWorld.GetTaqWuZhi(11, 2))
			{
				ChatHandler(_player).PSendSysMessage(LANG_TAQ_1);
				return;
			}
		...
		case 8580:
		case 8581:
			if (sWorld.GetTaqWuZhi(12, 1) >= sWorld.GetTaqWuZhi(12, 2))
			{
				ChatHandler(_player).PSendSysMessage(LANG_TAQ_1);
				return;
			}
		...
		case 8588:
		case 8589:
			if (sWorld.GetTaqWuZhi(13, 1) >= sWorld.GetTaqWuZhi(13, 2))
			{
				ChatHandler(_player).PSendSysMessage(LANG_TAQ_1);
				return;
			}
		...
		case 8600:
		case 8601:
			if (sWorld.GetTaqWuZhi(14, 1) >= sWorld.GetTaqWuZhi(14, 2))
			{
				ChatHandler(_player).PSendSysMessage(LANG_TAQ_1);
				return;
			}
		...
		case 8607:
		case 8608:
			if (sWorld.GetTaqWuZhi(15, 1) >= sWorld.GetTaqWuZhi(15, 2))
			{
				ChatHandler(_player).PSendSysMessage(LANG_TAQ_1);
				return;
			}
		...
		case 8609:
		case 8610:
			if (sWorld.GetTaqWuZhi(16, 1) >= sWorld.GetTaqWuZhi(16, 2))
			{
				ChatHandler(_player).PSendSysMessage(LANG_TAQ_1);
				return;
			}
		...
		case 8528:
		case 8529:
			if (sWorld.GetTaqWuZhi(20, 1) >= sWorld.GetTaqWuZhi(20, 2))
			{
				ChatHandler(_player).PSendSysMessage(LANG_TAQ_1);
				return;
			}
		...
		case 8613:
		case 8614:
			if (sWorld.GetTaqWuZhi(30, 1) >= sWorld.GetTaqWuZhi(30, 2))
			{
				ChatHandler(_player).PSendSysMessage(LANG_TAQ_1);
				return;
			}
        ...
        if (status == QUEST_STATUS_NONE)                    // For all other cases the mark is handled either at some place else, or with involved-relations already
        {
            if (pPlayer->CanSeeStartQuest(pQuest))
            {
                if (pPlayer->SatisfyQuestLevel(pQuest, false))
                {
                    ...
                    //if (pQuest->IsAutoComplete() || (pQuest->IsRepeatable() && pPlayer->getQuestStatusMap()[quest_id].m_rewarded)) 注释任务当机
